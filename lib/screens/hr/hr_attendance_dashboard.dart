...
class _HrAttendanceDashboardState extends State<HrAttendanceDashboard> {
  ...
  List<Widget> _buildAnomalies(ThemeData theme, bool isDark) {
    final anomalies = [
      ...
      {
        'name': 'Kavita Das',
        'issue': 'Absent without notice (2 days)',
        'dept': 'Design',
      ...
      {
        'name': 'Sunil Reddy',
        'issue': 'Consecutive late check-ins since Mon',
        'dept': 'Engineering',
      ...
      {
        'name': 'Pooja Iyer',
        'issue': 'Missing punch-out 3 times',
        'dept': 'Marketing',
      ...
      return Padding(
        ...
        child:
            NeuCard(
                ...
                .animate()
                .fadeIn(duration: 420.ms, delay: (640 + i * 60).ms)
                .slideY(
                  begin: 0.06,
                  end: 0,
                  duration: 420.ms,
