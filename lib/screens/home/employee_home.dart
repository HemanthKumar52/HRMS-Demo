      ...
      child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                provider.userName.isNotEmpty ? provider.userName.split(' ').first : 'User',
              ...
              _AttendanceTimerCard(provider: provider).animate().fadeIn(duration: 420.ms, delay: 160.ms).slideY(begin: 0.12, end: 0, duration: 420.ms, delay: 160.ms, curve: Curves.easeOutCubic),
                        ...
                        children: [
                          for (int i = 0; i < provider.leaveBalances.length && i < 3; i++) ...[
                            ...
                            _LeaveTypeChip(
                              ...
                              color: [AppColors.success, AppColors.orange, AppColors.primary][i % 3],
                              isDark: isDark,
                            ),
                          ],
                        ],
                      ...
                      Row(
                        children: [
                          _LeaveTypeChip(
                            label: 'Total',
                            used: 0,
                            total: provider.leaveBalance > 0 ? provider.leaveBalance : 1,
                            color: AppColors.primary,
                            isDark: isDark,
                          ),
                        ],
                      ...
                      ...provider.recentActivity.map((activity) {
                        ...
                        return Padding(
                          ...
                          child: Row(
                            children: [
                              Icon(
                                activity['type'] == 'leave' ? Icons.event_busy : Icons.description,
              ...
              NeuCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    if (provider.userProfile['reporting_manager'] != null) ...[
                      _OrgChainItem(
                        name: provider.userProfile['reporting_manager']['name'] ?? 'Manager',
                    ...
                    _OrgChainItem(
                      ...
                      role: '${provider.designation}${provider.department.isNotEmpty ? ' • ${provider.department}' : ''}',
                      color: AppColors.success,
                      isYou: true,
                      isLast: true,
                    ),
                    ...
                    if (provider.userProfile['date_of_joining'] != null) ...[
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text('Joined: ${provider.userProfile['date_of_joining']}',
                              style: theme.textTheme.bodySmall),
                        ],
                      ),
                    ],
              ...
              // Quick Actions
              Text('Quick Actions', style: theme.textTheme.titleMedium).animate().fadeIn(duration: 420.ms, delay: 560.ms).slideY(begin: 0.12, end: 0, duration: 420.ms, delay: 560.ms, curve: Curves.easeOutCubic),
              const SizedBox(height: 12),
              GridView.count(
                shrinkWrap: true,
              ...
              // Recent Activity
              // Recent Activity
              Text('Recent Activity', style: theme.textTheme.titleMedium).animate().fadeIn(duration: 420.ms, delay: 720.ms).slideY(begin: 0.12, end: 0, duration: 420.ms, delay: 720.ms, curve: Curves.easeOutCubic),
              const SizedBox(height: 12),
              NeuCard(
                child: Column(
                  children: [
                    ...
                    if (provider.pendingLeaves > 0) ...[
                      _ActivityItem(
                        ...
                        color: AppColors.orange,
                        title: 'Leave Request',
                        subtitle: '${provider.pendingLeaves} leave request(s) pending',
                        time: 'Pending',
                      ),
                      Divider(
                        height: 20,
                    ...
                    if (provider.recentAttendance.isEmpty && provider.pendingLeaves == 0 && provider.openTickets == 0)
                      _ActivityItem(
              ...
              ).animate().fadeIn(duration: 420.ms, delay: 800.ms).slideY(begin: 0.12, end: 0, duration: 420.ms, delay: 800.ms, curve: Curves.easeOutCubic),
              const SizedBox(height: 20),
            ],
          ),
    ),
