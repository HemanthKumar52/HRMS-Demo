...
class Responsive {
  ...
  /// Check device type
  static bool isPhone(BuildContext context) => deviceType(context) == DeviceType.phone;
  ...
  static double maxContentWidth(BuildContext context) {
    return value(context, phone: double.infinity, tablet: 700.0, desktop: 900.0);
  }

  /// Grid cross axis count
  static int gridColumns(BuildContext context, {int phoneCols = 3, int tabletCols = 4, int desktopCols = 6}) {
    return value(context, phone: phoneCols, tablet: tabletCols, desktop: desktopCols);
  }
