...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '5/minute',  # Login attempts: 5 per minute for unauthenticated
        'user': '60/minute',  # Authenticated API calls: 60 per minute
        'login': '5/minute',  # Login-specific: 5 attempts per minute
    },
}
